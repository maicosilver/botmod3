		...
		try {
			...
			mess = {
				...
				only: {
					...
					admin: 'Este comando só pode ser usado por adms do grupo!',
					Badmin: 'Este comando só pode ser usado quando o bot se torna administrador!'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["558896724995@s.whatsapp.net"] // replace this with your number
			...
			switch(command) {
                ...
                if (isMedia && type === 'video' || mimetype === 'image/gif') {
                    ...
                    try {
                        ...
                        await bocchi.sendMp4AsSticker(from, videoBase64, { fps: 30, startTime: '00:00:00.0', endTime : '00:00:05.0', loop: 0 },{ author: 'powsitos.com', pack: 'Creado por CriSa-Bot', keepScale:'true' })
                            .then(async () => {
